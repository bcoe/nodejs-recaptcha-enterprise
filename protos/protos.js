      ...
      cloud.recaptchaenterprise = (function() {
        ...
        recaptchaenterprise.v1beta1 = (function() {
          ...
          v1beta1.RecaptchaEnterpriseServiceV1Beta1 = (function() {
             ...
             */
            function RecaptchaEnterpriseServiceV1Beta1(
              rpcImpl,
              requestDelimited,
              responseDelimited
            ) {
            ...
            (RecaptchaEnterpriseServiceV1Beta1.prototype = Object.create(
              $protobuf.rpc.Service.prototype
            )).constructor = RecaptchaEnterpriseServiceV1Beta1;
             ...
             */
            RecaptchaEnterpriseServiceV1Beta1.create = function create(
              rpcImpl,
              requestDelimited,
              responseDelimited
            ) {
            ...
            Object.defineProperty(
              (RecaptchaEnterpriseServiceV1Beta1.prototype.createAssessment = function createAssessment(
                request,
                callback
              ) {
                return this.rpcCall(
                  createAssessment,
                  $root.google.cloud.recaptchaenterprise.v1beta1
                    .CreateAssessmentRequest,
                  $root.google.cloud.recaptchaenterprise.v1beta1.Assessment,
                  request,
                  callback
                );
              }),
             ...
             */
            Object.defineProperty(
              (RecaptchaEnterpriseServiceV1Beta1.prototype.annotateAssessment = function annotateAssessment(
                request,
                callback
              ) {
                return this.rpcCall(
          ...
          v1beta1.CreateAssessmentRequest = (function() {
            ...
            CreateAssessmentRequest.encode = function encode(message, writer) {
              ...
              if (
                ...
                message.hasOwnProperty('assessment')
              )
                $root.google.cloud.recaptchaenterprise.v1beta1.Assessment.encode(
                  message.assessment,
             ...
             * @returns {$protobuf.Writer} Writer
             */
            CreateAssessmentRequest.encodeDelimited = function encodeDelimited(
              message,
              writer
            ) {
            ...
            CreateAssessmentRequest.decode = function decode(reader, length) {
              ...
              var end = length === undefined ? reader.len : reader.pos + length,
                message = new $root.google.cloud.recaptchaenterprise.v1beta1.CreateAssessmentRequest();
              while (reader.pos < end) {
                ...
                switch (tag >>> 3) {
                  case 1:
                    ...
                    break;
                  case 2:
                    message.assessment = $root.google.cloud.recaptchaenterprise.v1beta1.Assessment.decode(
                      reader,
                      reader.uint32()
                    );
                    break;
             ...
             * @throws {$protobuf.util.ProtocolError} If required fields are missing
             */
            CreateAssessmentRequest.decodeDelimited = function decodeDelimited(
              reader
            ) {
            ...
            CreateAssessmentRequest.verify = function verify(message) {
              ...
              if (
                ...
                var error = $root.google.cloud.recaptchaenterprise.v1beta1.Assessment.verify(
                  message.assessment
                );
                if (error) return 'assessment.' + error;
              }
              return null;
            };
            ...
            CreateAssessmentRequest.fromObject = function fromObject(object) {
              ...
              if (object.assessment != null) {
                if (typeof object.assessment !== 'object')
                  throw TypeError(
                    '.google.cloud.recaptchaenterprise.v1beta1.CreateAssessmentRequest.assessment: object expected'
                  );
                message.assessment = $root.google.cloud.recaptchaenterprise.v1beta1.Assessment.fromObject(
                  object.assessment
                );
              }
              return message;
             ...
             */
            CreateAssessmentRequest.toObject = function toObject(
              message,
              options
            ) {
              if (!options) options = {};
              ...
              if (
                ...
                object.assessment = $root.google.cloud.recaptchaenterprise.v1beta1.Assessment.toObject(
                  message.assessment,
                  options
                );
              return object;
          ...
          v1beta1.AnnotateAssessmentRequest = (function() {
             ...
             * @returns {$protobuf.Writer} Writer
             */
            AnnotateAssessmentRequest.encode = function encode(
              message,
              writer
            ) {
              if (!writer) writer = $Writer.create();
             ...
             * @returns {$protobuf.Writer} Writer
             */
            AnnotateAssessmentRequest.encodeDelimited = function encodeDelimited(
              message,
              writer
            ) {
              return this.encode(message, writer).ldelim();
            ...
            AnnotateAssessmentRequest.decode = function decode(reader, length) {
              if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
              var end = length === undefined ? reader.len : reader.pos + length,
                message = new $root.google.cloud.recaptchaenterprise.v1beta1.AnnotateAssessmentRequest();
              while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                  case 1:
             ...
             * @throws {$protobuf.util.ProtocolError} If required fields are missing
             */
            AnnotateAssessmentRequest.decodeDelimited = function decodeDelimited(
              reader
            ) {
              if (!(reader instanceof $Reader)) reader = new $Reader(reader);
              return this.decode(reader, reader.uint32());
             ...
             * @returns {Object.<string,*>} Plain object
             */
            AnnotateAssessmentRequest.toObject = function toObject(
              message,
              options
            ) {
              if (!options) options = {};
              ...
              if (options.defaults) {
                object.name = '';
                object.annotation =
                  options.enums === String ? 'ANNOTATION_UNSPECIFIED' : 0;
              }
              if (message.name != null && message.hasOwnProperty('name'))
          ...
          v1beta1.AnnotateAssessmentResponse = (function() {
             ...
             * @returns {$protobuf.Writer} Writer
             */
            AnnotateAssessmentResponse.encode = function encode(
              message,
              writer
            ) {
              if (!writer) writer = $Writer.create();
             ...
             * @returns {$protobuf.Writer} Writer
             */
            AnnotateAssessmentResponse.encodeDelimited = function encodeDelimited(
              message,
              writer
            ) {
              return this.encode(message, writer).ldelim();
             ...
             * @throws {$protobuf.util.ProtocolError} If required fields are missing
             */
            AnnotateAssessmentResponse.decode = function decode(
              reader,
              length
            ) {
              if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
              var end = length === undefined ? reader.len : reader.pos + length,
                message = new $root.google.cloud.recaptchaenterprise.v1beta1.AnnotateAssessmentResponse();
              while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                  default:
             ...
             * @throws {$protobuf.util.ProtocolError} If required fields are missing
             */
            AnnotateAssessmentResponse.decodeDelimited = function decodeDelimited(
              reader
            ) {
              if (!(reader instanceof $Reader)) reader = new $Reader(reader);
              return this.decode(reader, reader.uint32());
             ...
             * @returns {google.cloud.recaptchaenterprise.v1beta1.AnnotateAssessmentResponse} AnnotateAssessmentResponse
             */
            AnnotateAssessmentResponse.fromObject = function fromObject(
              object
            ) {
              if (
                object instanceof
          ...
          v1beta1.Assessment = (function() {
            ...
            Assessment.encode = function encode(message, writer) {
              ...
              if (message.event != null && message.hasOwnProperty('event'))
                $root.google.cloud.recaptchaenterprise.v1beta1.Event.encode(
                  message.event,
                  writer.uint32(/* id 2, wireType 2 =*/ 18).fork()
                ).ldelim();
              ...
              if (
                message.tokenProperties != null &&
                message.hasOwnProperty('tokenProperties')
              )
                $root.google.cloud.recaptchaenterprise.v1beta1.TokenProperties.encode(
             ...
             * @returns {$protobuf.Writer} Writer
             */
            Assessment.encodeDelimited = function encodeDelimited(
              message,
              writer
            ) {
              return this.encode(message, writer).ldelim();
            ...
            Assessment.decode = function decode(reader, length) {
              if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
              var end = length === undefined ? reader.len : reader.pos + length,
                message = new $root.google.cloud.recaptchaenterprise.v1beta1.Assessment();
              while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                  case 1:
                    ...
                    break;
                  case 2:
                    message.event = $root.google.cloud.recaptchaenterprise.v1beta1.Event.decode(
                      reader,
                      reader.uint32()
                    );
                    break;
                  case 3:
                    ...
                    break;
                  case 4:
                    message.tokenProperties = $root.google.cloud.recaptchaenterprise.v1beta1.TokenProperties.decode(
                      reader,
                      reader.uint32()
                    );
                    break;
            ...
            Assessment.verify = function verify(message) {
              ...
              if (message.name != null && message.hasOwnProperty('name'))
                if (!$util.isString(message.name))
                  return 'name: string expected';
              if (message.event != null && message.hasOwnProperty('event')) {
                var error = $root.google.cloud.recaptchaenterprise.v1beta1.Event.verify(
                  message.event
                );
              ...
              if (
                ...
                var error = $root.google.cloud.recaptchaenterprise.v1beta1.TokenProperties.verify(
                  message.tokenProperties
                );
                if (error) return 'tokenProperties.' + error;
              }
              if (
                message.reasons != null &&
                message.hasOwnProperty('reasons')
              ) {
            ...
            Assessment.fromObject = function fromObject(object) {
              ...
              if (object.event != null) {
                if (typeof object.event !== 'object')
                  throw TypeError(
                    '.google.cloud.recaptchaenterprise.v1beta1.Assessment.event: object expected'
                  );
                message.event = $root.google.cloud.recaptchaenterprise.v1beta1.Event.fromObject(
                  object.event
                );
              }
              ...
              if (object.tokenProperties != null) {
                if (typeof object.tokenProperties !== 'object')
                  throw TypeError(
                    '.google.cloud.recaptchaenterprise.v1beta1.Assessment.tokenProperties: object expected'
                  );
                message.tokenProperties = $root.google.cloud.recaptchaenterprise.v1beta1.TokenProperties.fromObject(
              ...
              if (object.reasons) {
                if (!Array.isArray(object.reasons))
                  throw TypeError(
                    '.google.cloud.recaptchaenterprise.v1beta1.Assessment.reasons: array expected'
                  );
                message.reasons = [];
            ...
            Assessment.toObject = function toObject(message, options) {
              if (!options) options = {};
              var object = {};
              if (options.arrays || options.defaults) object.reasons = [];
              if (options.defaults) {
                object.name = '';
                object.event = null;
                object.score = 0;
              ...
              if (message.name != null && message.hasOwnProperty('name'))
                object.name = message.name;
              if (message.event != null && message.hasOwnProperty('event'))
                object.event = $root.google.cloud.recaptchaenterprise.v1beta1.Event.toObject(
                  message.event,
                  options
                );
              if (message.score != null && message.hasOwnProperty('score'))
              ...
              if (
                ...
                object.tokenProperties = $root.google.cloud.recaptchaenterprise.v1beta1.TokenProperties.toObject(
                  message.tokenProperties,
                  options
                );
              if (message.reasons && message.reasons.length) {
                ...
                for (var j = 0; j < message.reasons.length; ++j)
                  object.reasons[j] =
                    options.enums === String
                      ? $root.google.cloud.recaptchaenterprise.v1beta1
                          .Assessment.ClassificationReason[message.reasons[j]]
                      : message.reasons[j];
              }
              return object;
            };
          ...
          v1beta1.Event = (function() {
            ...
            Event.decode = function decode(reader, length) {
              if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
              var end = length === undefined ? reader.len : reader.pos + length,
                message = new $root.google.cloud.recaptchaenterprise.v1beta1.Event();
              while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                  case 1:
            ...
            Event.fromObject = function fromObject(object) {
              if (
                object instanceof
                $root.google.cloud.recaptchaenterprise.v1beta1.Event
              )
                return object;
          ...
          v1beta1.TokenProperties = (function() {
            ...
            TokenProperties.encode = function encode(message, writer) {
              ...
              if (
                message.invalidReason != null &&
                message.hasOwnProperty('invalidReason')
              )
                writer
                  .uint32(/* id 2, wireType 0 =*/ 16)
                  .int32(message.invalidReason);
              if (
                message.createTime != null &&
                message.hasOwnProperty('createTime')
              )
              ...
              if (
                ...
                message.hasOwnProperty('hostname')
              )
                writer
             ...
             * @returns {$protobuf.Writer} Writer
             */
            TokenProperties.encodeDelimited = function encodeDelimited(
              message,
              writer
            ) {
              return this.encode(message, writer).ldelim();
            ...
            TokenProperties.decode = function decode(reader, length) {
              if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
              var end = length === undefined ? reader.len : reader.pos + length,
                message = new $root.google.cloud.recaptchaenterprise.v1beta1.TokenProperties();
              while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                  case 1:
                  ...
                  case 2:
                    ...
                    break;
                  case 3:
                    message.createTime = $root.google.protobuf.Timestamp.decode(
                      reader,
                      reader.uint32()
                    );
                    break;
            ...
            TokenProperties.fromObject = function fromObject(object) {
              if (
                object instanceof
                $root.google.cloud.recaptchaenterprise.v1beta1.TokenProperties
              )
                return object;
              ...
              if (object.createTime != null) {
                if (typeof object.createTime !== 'object')
                  throw TypeError(
                    '.google.cloud.recaptchaenterprise.v1beta1.TokenProperties.createTime: object expected'
                  );
                message.createTime = $root.google.protobuf.Timestamp.fromObject(
                  object.createTime
                );
              }
            ...
            TokenProperties.toObject = function toObject(message, options) {
              ...
              if (options.defaults) {
                ...
                object.invalidReason =
                  options.enums === String ? 'INVALID_REASON_UNSPECIFIED' : 0;
              ...
              if (
                ...
                object.invalidReason =
                  options.enums === String
                    ? $root.google.cloud.recaptchaenterprise.v1beta1
                        .TokenProperties.InvalidReason[message.invalidReason]
                    : message.invalidReason;
              if (
                message.createTime != null &&
                message.hasOwnProperty('createTime')
              )
                object.createTime = $root.google.protobuf.Timestamp.toObject(
                  message.createTime,
                  options
                );
              if (
